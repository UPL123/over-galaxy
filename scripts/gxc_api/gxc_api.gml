...
/// @param {method} callback The function to be called upon task completion.
/// @param {struct} options This struct can contain pagination/track values (page, pageSize, trackId)
/// @returns {integer} The http request unique identifier.
...
/// @function gxc_challenge_submit_score(score, callback)
/// @description Submits a new challenge score.
/// @param {real} score The new score to be submitted.
/// @param {method} callback The function to be called upon task completion.
/// @returns {integer} The http request unique identifier.
function gxc_challenge_submit_score(_score, _callback = undefined) {
...
function gxc_submit_challenge_score(_score, _callback = undefined) {
	...
	gxc_challenge_submit_score(_score, _callback = undefined);
}
...
function __gxc_struct_to_params(_struct, _names) {
	...
	repeat(_count) {
		...
		// we need to check for both null or undefined
		if (is_undefined(_value) || _value == pointer_null) continue;
